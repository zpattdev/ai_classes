...
class Parser(object):
    ...
    def parse(self, dataset, device, eval_batch_size=5000):
        sentences = []
        sentence_id_to_idx = {}
        ...
        dependencies = minibatch_parse(sentences, model, device, eval_batch_size)
...
class ModelWrapper(object):
    ...
    def predict(self, partial_parses, device):
        ...
        pred = self.parser.model(mb_x.to(device=device))
